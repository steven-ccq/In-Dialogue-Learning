...
class DPOCTrainer(Trainer):
    ...
    def dpo_loss(
        ...
        policy_criterion_logps: torch.FloatTensor,
        reference_chosen_logps: torch.FloatTensor,
        reference_rejected_logps: torch.FloatTensor,
        reference_criterion_logps: torch.FloatTensor,
        reference_free: bool = False,
        criterion_free: bool = False,
        ...
        if not criterion_free:
            chosen_logratios = policy_chosen_logps - reference_chosen_logps
            rejected_logratios = policy_rejected_logps - reference_rejected_logps
            crt_logratios = policy_criterion_logps - reference_criterion_logps

            logits += self.penality * (torch.clamp(chosen_logratios - crt_logratios, max=0.0) + torch.clamp(crt_logratios - rejected_logratios, max=0.0))
        ...
        crt_rewards = self.beta * (policy_criterion_logps - reference_criterion_logps).detach()

        return losses, chosen_rewards, rejected_rewards, crt_rewards
