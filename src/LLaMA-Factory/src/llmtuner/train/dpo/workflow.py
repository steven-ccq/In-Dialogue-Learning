...
from llmtuner.train.dpo.trainer import CustomDPOTrainer, CustomDPOCTrainer
...
def run_dpo(
    ...
    if 'criterion_ids' in dataset.features:
        print(dataset.features)
        print('Using DPOC instead of DPO.')
        trainer = CustomDPOCTrainer(
